...
const Profile = require('../../models/Agency');
...
//  * @desc    Delete a user profile and also user and post
//  * @access  Priavte
// */ 
...
//  * @desc    Updating part of a user profile
//  * @desc    adding profile experiences
//  * @access  Priavte
// */
...
//     try {
//         const options = {
//             uri: `https://api.github.com/users/${req.params.username}/repos?per_pages=5&sort=creared:asc&client_id=${config.get('GITHUB_CLIENT_ID')}&client_secret=${config.get('GITHUB_SECRET')}`,
//             method: 'GET',
